              ...
              <div class="container">
                  <div class="row">
                    ...
                    {{-- @foreach($blogs as $key => $blog) --}}
                          <h3 class="mb-5 text-center" style="font-size:3.5rem;color:#274685;">{{ $blog->title}}</h3>
                          <div class="col-md-8 blog-content mt-4">
                              <div class="row mb-5">
                                  <div class="col-md-6">
                                      <figure>
                                        @if(!empty($blog->image))
                                        <img src="{{ $blog->image }}" alt="Free Website Template by Free-Template.co"
                                              class="img-fluid" style="width:100%; height:368px;">
                                        @else
                                        <img src="{{ 'https://res.cloudinary.com/dvhfyuilj/image/upload/v1676466827/noooimxvcb5zwqufqs0n.jpg' }}" alt="Free Website Template by Free-Template.co"
                                              class="img-fluid" style="width:100%; height:368px;">
                                        @endif
                              ...
                              {{-- <div class="pt-5">
                                  ...
                                  <ul class="comment-list">
                                      <li class="comment">
                                          <div class="vcard bio">
                                              <img src="{{ asset('https://res.cloudinary.com/dvhfyuilj/image/upload/v1676635033/qc2wyjzybfm2l3e1x8ri.jpg') }}"
                                      ...
                                      <li class="comment">
                                          <div class="vcard bio">
                                              <img src="{{ 'https://res.cloudinary.com/dvhfyuilj/image/upload/v1676635033/qc2wyjzybfm2l3e1x8ri.jpg' }}"
                                                  alt="Image placeholder">
                                          </div>
                                          <div class="comment-body">
                                              <h3>Jean Doe</h3>
                          ...
                          <div class="col-md-4 sidebar">
                              <div class="sidebar-box">
                                  <img src="{{ 'https://res.cloudinary.com/dvhfyuilj/image/upload/v1676714499/pvodujxmcv8tt4lkazmr.png' }}"
